...
class RelayBeacon extends RelayNode {
    constructor(opts, callback) {
        ...
        const accountJSON = HyperDHT.keyPair(this._seed);
        const account = ScarZebraAccount.fromJSON(accountJSON);

        this._accountJSON = accountJSON;
    ...
    static createSync(port, opts={}, cb=null) {
        ...
        return new RelayBeacon(opts, cb);
    }
    ...
    publicKeyHexString() {
        return this._account.publicKey.toString('hex');
    }
